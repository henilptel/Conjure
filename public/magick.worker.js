...
type WorkerResponse = InitCompleteResponse | InitErrorResponse | ProcessCompleteResponse | ProcessErrorResponse;
      ...
      if (tools.length === 0) {
        ImageMagick.read(bytes, (image) => {
          try {
            ...
            const errorMessage = error instanceof Error ? `${error.message}\n${error.stack || ''}` : 'Unknown processing error';
            resolve({
              type: 'process-error',
              requestId,
              error: errorMessage,
